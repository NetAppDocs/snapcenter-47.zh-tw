...
只為了恢復單一郵件而還原完整的資料庫、將耗費大量時間和資源。SMBR建立Snapshot的複本、然後使用Microsoft API在SMBR中掛載信箱、有助於快速恢復郵件。如需如何使用SMBR的詳細資訊、請參閱 https://library.netapp.com/ecm/ecm_download_file/ECMLP2871407["SMBR系統管理指南"^]。
