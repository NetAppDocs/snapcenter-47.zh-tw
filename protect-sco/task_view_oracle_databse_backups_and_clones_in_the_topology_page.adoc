...
或者、您也可以參閱 https://library.netapp.com/ecm/ecm_download_file/ECMLP2883301["《軟件命令參考指南》SnapCenter"^] 或 https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["《軟件指令程式參考指南》SnapCenter"^]。
