...
|===
如需支援版本的最新資訊、請參閱 https://imt.netapp.com/matrix/imt.jsp?components=105283;&solution=1259&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
...
NOTE: 如果您要管理RAC設定、非root使用者應該是Oracle使用者、而且不能只是任何非root OS使用者。
